...
const UserRow: React.FC<UserRowProps> = ({ user, index, deleteUser, expandedRowIndex, handleNameToggle }) => {
    ...
    return (
        <tr onClick={handleRowClick}>
            <td>{index + 1}</td>
            <td className={isExpanded ? "" : "truncateName"}>{user.name}</td>
            <td>{user.age}</td>
            ...
            <td>
                <ViewsButton
                    ...
                    pathD2={"M2.18565 18.0974C2.08466 15.821 3.903 13.9202 6.18172 13.9202H43.8189C46.0976 13.9202 47.916 15.821 47.815 18.0975L46.1699 55.1775C46.0751 57.3155 44.314 59.0002 42.1739 59.0002H7.8268C5.68661 59.0002 3.92559 57.3155 3.83073 55.1775L2.18565 18.0974ZM18.0003 49.5402C16.6196 49.5402 15.5003 48.4209 15.5003 47.0402V24.9602C15.5003 23.5795 16.6196 22.4602 18.0003 22.4602C19.381 22.4602 20.5003 23.5795 20.5003 24.9602V47.0402C20.5003 48.4209 19.381 49.5402 18.0003 49.5402ZM29.5003 47.0402C29.5003 48.4209 30.6196 49.5402 32.0003 49.5402C33.381 49.5402 34.5003 48.4209 34.5003 47.0402V24.9602C34.5003 23.5795 33.381 22.4602 32.0003 22.4602C30.6196 22.4602 29.5003 23.5795 29.5003 24.9602Z"}
                    clipRule="evenodd"
                    fillRule="evenodd"
                />
            </td>
