...
import "./Users.css";
import { User } from "../../../types"; // Importa la interfaz desde el archivo types

interface UsersProps {
    searchResults: User[];
}

const Users: React.FC<UsersProps> = ({ searchResults }) => {
    ...
    return (
        <div>
            ...
            <div className={`box ${expandedRowIndex !== null ? "expand" : ""}`}>
                <UserTable
            ...
            <div className="fixed-buttons">
                <ViewsButton
                    ...
                    onClick={() => window.open("https://github.com/HiramMasso", "_blank")}
                />
                <ViewsButton
                    ...
                    onClick={() => window.open("https://www.linkedin.com/in/hiram-masso-30a77b192/", "_blank")}
                />
            </div>
        </div>
    );
